...
public class ConverterServiceImpl implements ConverterService {
    ...
    @Override
    public void convertToXls(String inputPath, String outputPath) {
    ...
    @Override
    public void convertToHtml(String inputPath, String outputPath) {
    ...
    public void convertToXML(String inputPath, String outputPath) {
        ...
        try {
            ...
            e.printStackTrace();
            LOGGER.info("File wasn't found, error: " + e);
    ...
    @Override
    public void convertJsonToCSV(JSONArray response, String path) {
        try {
